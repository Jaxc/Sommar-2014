...
-- The decoder for BCH code (127,113), t=2
 -- with optimization= 1.
...
ARCHITECTURE dcounta OF dcount IS	
  ...
  BEGIN
	pe<=  cout(0) AND NOT cout(1) AND NOT cout(2) AND NOT cout(3) AND NOT cout(4) AND NOT cout(5) AND NOT cout(6);
		-- pe=1 if count=0
	cef1<=  NOT cout(0) AND cout(1) AND NOT cout(2) AND NOT cout(3) AND NOT cout(4) AND NOT cout(5) AND NOT cout(6);
		-- cef=1 if count= 1;
	cef<= cef1;
	vdoutS<= nFirst AND cef1;
		-- vdout=1 if count=1
	vdoutR<= reset OR ( NOT cout(0) AND NOT cout(1) AND cout(2) AND NOT cout(3) AND cout(4) AND NOT cout(5) AND cout(6));
...
ARCHITECTURE dsyn3a OF dsyn3 IS
  ...
  PROCESS BEGIN
	...
	ELSE
	syn(0)<= din XOR syn(4);
	syn(1)<= syn(4) XOR syn(5);
	syn(2)<= syn(5) XOR syn(6);
	syn(3)<= syn(0) XOR syn(6);
	syn(4)<= syn(1);
	syn(5)<= syn(2);
	syn(6)<= syn(3);
	END IF;
...
ARCHITECTURE dpow3a OF dpow3 IS
	SIGNAL dxor: BIT_VECTOR(0 TO 41);
  BEGIN
	dxor(0 TO m-1)<= din;
	dxor(7)<= din(0) AND din(1);
	dxor(8)<= din(0) AND din(2);
	dxor(9)<= din(0) AND din(3);
	dxor(10)<= din(0) AND din(4);
	dxor(11)<= din(0) AND din(5);
	dxor(12)<= din(0) AND din(6);
	dxor(13)<= din(1) AND din(2);
	dxor(14)<= din(1) AND din(3);
	dxor(15)<= din(1) AND din(4);
	dxor(16)<= din(1) AND din(5);
	dxor(17)<= din(1) AND din(6);
	dxor(18)<= din(2) AND din(3);
	dxor(19)<= din(2) AND din(4);
	dxor(20)<= din(2) AND din(5);
	dxor(21)<= din(2) AND din(6);
	dxor(22)<= din(3) AND din(4);
	dxor(23)<= din(3) AND din(5);
	dxor(24)<= din(3) AND din(6);
	dxor(25)<= din(4) AND din(5);
	dxor(26)<= din(4) AND din(6);
	dxor(27)<= din(5) AND din(6);
	dxor(28)<= dxor(16) XOR dxor(23); -- 3
	dxor(29)<= dxor(10) XOR dxor(19); -- 2
	dxor(30)<= dxor(11) XOR dxor(27); -- 2
	dxor(31)<= dxor(14) XOR dxor(28); -- 2
	dxor(32)<= dxor(15) XOR dxor(20); -- 2
	dxor(33)<= dxor(3) XOR dxor(21); -- 1
	dxor(34)<= dxor(4) XOR dxor(24); -- 1
	dxor(35)<= dxor(5) XOR dxor(24); -- 1
	dxor(36)<= dxor(7) XOR dxor(25); -- 1
	dxor(37)<= dxor(8) XOR dxor(29); -- 1
	dxor(38)<= dxor(9) XOR dxor(32); -- 1
	dxor(39)<= dxor(13) XOR dxor(30); -- 1
	dxor(40)<= dxor(17) XOR dxor(18); -- 1
	dxor(41)<= dxor(21) XOR dxor(26); -- 1
		-- optimization saving = 20 XOR gates
	dout(0)<= dxor(0) XOR dxor(31) XOR dxor(40) XOR dxor(41);
	dout(1)<= dxor(29) XOR dxor(31) XOR dxor(35) XOR dxor(36);
	dout(2)<= dxor(27) XOR dxor(32) XOR dxor(33) XOR dxor(36) XOR dxor(37) XOR dxor(40);
	dout(3)<= dxor(1) XOR dxor(19) XOR dxor(22) XOR dxor(30) XOR dxor(33) XOR dxor(35) XOR dxor(38);
	dout(4)<= dxor(6) XOR dxor(28) XOR dxor(37) XOR dxor(39) XOR dxor(41);
	dout(5)<= dxor(12) XOR dxor(20) XOR dxor(22) XOR dxor(31) XOR dxor(34) XOR dxor(39);
	dout(6)<= dxor(2) XOR dxor(6) XOR dxor(17) XOR dxor(23) XOR dxor(25) XOR dxor(34) XOR dxor(38);
		-- 46 XOR gates
...
ARCHITECTURE dch1a OF dch1 IS
	...
	SIGNAL ch: BIT_VECTOR(0 TO 6); -- ch registers and optimization 
  BEGIN
...
ARCHITECTURE dch3a OF dch3 IS
  ...
  BEGIN
	...
	chin(2)<= ch(5) XOR ch(6);
	chin(3)<= ch0reg XOR ch(6);
	chin(4)<= ch(1);
	chin(5)<= ch(2);
	chin(6)<= ch(3);
  PROCESS BEGIN
