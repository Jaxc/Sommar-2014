...
-- The decoder for BCH code (31,21), t=2
 -- with optimization= 1.
...
ARCHITECTURE dcounta OF dcount IS	
  ...
  BEGIN
	pe<=  cout(0) AND NOT cout(1) AND NOT cout(2) AND NOT cout(3) AND NOT cout(4);
		-- pe=1 if count=0
	cef1<=  NOT cout(0) AND cout(1) AND NOT cout(2) AND NOT cout(3) AND NOT cout(4);
		-- cef=1 if count= 1;
	cef<= cef1;
	vdoutS<= nFirst AND cef1;
		-- vdout=1 if count=1
	vdoutR<= reset OR ( cout(0) AND NOT cout(1) AND cout(2) AND NOT cout(3) AND cout(4));
...
ARCHITECTURE dpow3a OF dpow3 IS
	SIGNAL dxor: BIT_VECTOR(0 TO 21);
  BEGIN
	dxor(0 TO m-1)<= din;
	dxor(5)<= din(0) AND din(1);
	dxor(6)<= din(0) AND din(2);
	dxor(7)<= din(0) AND din(3);
	dxor(8)<= din(0) AND din(4);
	dxor(9)<= din(1) AND din(2);
	dxor(10)<= din(1) AND din(3);
	dxor(11)<= din(1) AND din(4);
	dxor(12)<= din(2) AND din(3);
	dxor(13)<= din(2) AND din(4);
	dxor(14)<= din(3) AND din(4);
	dxor(15)<= dxor(8) XOR dxor(9); -- 2
	dxor(16)<= dxor(2) XOR dxor(3); -- 1
	dxor(17)<= dxor(4) XOR dxor(5); -- 1
	dxor(18)<= dxor(6) XOR dxor(13); -- 1
	dxor(19)<= dxor(10) XOR dxor(12); -- 1
	dxor(20)<= dxor(14) XOR dxor(15); -- 1
	dxor(21)<= dxor(18) XOR dxor(20); -- 1
		-- optimization saving = 8 XOR gates
	dout(0)<= dxor(0) XOR dxor(15) XOR dxor(19);
	dout(1)<= dxor(7) XOR dxor(14) XOR dxor(16) XOR dxor(17);
	dout(2)<= dxor(17) XOR dxor(21);
	dout(3)<= dxor(1) XOR dxor(4) XOR dxor(8) XOR dxor(12) XOR dxor(13) XOR dxor(16);
	dout(4)<= dxor(3) XOR dxor(11) XOR dxor(19) XOR dxor(21);
		-- 21 XOR gates
