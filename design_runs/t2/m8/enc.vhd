...
-- The encoder for BCH code (255,239), t=2
 -- with optimization= 1.
...
ARCHITECTURE eringa OF ering IS
  ...
  BEGIN
	...
	rin(14)<= rout(13) XOR rin0;
	rin(15)<= rout(14);
	-- Polynomial generating encoder: 1+a1*x+a2*x^2+...
	--11000110111101101
	-- Number of XOR gates= 9
...
BEGIN
	vdinR<= cout(0) AND cout(1) AND NOT cout(2) AND cout(3) AND NOT cout(4) AND NOT cout(5) AND NOT cout(6) AND NOT cout(7); 
		-- reset vdin if cout==k-1
	vdinS<= ( NOT cout(0) AND cout(1) AND cout(2) AND cout(3) AND NOT cout(4) AND NOT cout(5) AND NOT cout(6) AND cout(7)) OR reset; 
		-- vdinS=1 if cout==n-1
