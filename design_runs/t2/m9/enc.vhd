...
-- The encoder for BCH code (511,493), t=2
 -- with optimization= 1.
...
ARCHITECTURE eringa OF ering IS
  ...
  BEGIN
	...
	rin(9)<= rout(8);
	rin(10)<= rout(9) XOR rin0;
	rin(11)<= rout(10);
	rin(12)<= rout(11) XOR rin0;
	rin(13)<= rout(12);
	rin(14)<= rout(13);
	rin(15)<= rout(14) XOR rin0;
	rin(16)<= rout(15);
	rin(17)<= rout(16);
...
BEGIN
	vdinR<= NOT cout(0) AND cout(1) AND NOT cout(2) AND cout(3) AND NOT cout(4) AND NOT cout(5) AND cout(6) AND cout(7) AND cout(8); 
		-- reset vdin if cout==k-1
	vdinS<= ( NOT cout(0) AND NOT cout(1) AND NOT cout(2) AND cout(3) AND NOT cout(4) AND NOT cout(5) AND NOT cout(6) AND NOT cout(7) AND cout(8)) OR reset; 
		-- vdinS=1 if cout==n-1
