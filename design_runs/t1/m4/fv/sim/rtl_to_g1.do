...
usage -auto
set log file fv/sim/rtl_to_g1.log -replace
// tclmode
...
vpx read guide file fv/sim/rtl_to_g1.ovf
...
set root module sim -golden
read design -verilog \
	-unzip fv/sim/g1.v.gz \
	-revised -lastmod
set root module sim -revised
report design data
report black box
...
write hier_compare dofile fv/sim/hier_rtl_to_g1.do \
...
run hier_compare fv/sim/hier_rtl_to_g1.do
usage
