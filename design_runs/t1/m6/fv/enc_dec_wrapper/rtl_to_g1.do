...
usage -auto
set log file fv/enc_dec_wrapper/rtl_to_g1.log -replace
// tclmode
// set env(CDN_SYNTH_ROOT) /chalmers/sw/sup/cds/edi-10.12.002/tools
// vpxmode

tclmode
puts "Start: Reading OVF file"
vpx read guide file fv/enc_dec_wrapper/rtl_to_g1.ovf
...
read library -statetable -liberty \
	/chalmers/sw/sup/cds/cmos065-5.3.4/CORE65LPSVT_5.1/libs/CORE65LPSVT_nom_1.20V_25C.lib \
	-both
...
read design -verilog \
	-unzip fv/enc_dec_wrapper/g1.v.gz \
	-revised -lastmod
set root module enc_dec_wrapper -revised
report design data
report black box
...
write hier_compare dofile fv/enc_dec_wrapper/hier_rtl_to_g1.do \
...
run hier_compare fv/enc_dec_wrapper/hier_rtl_to_g1.do
usage
