...
-- The encoder for BCH code (63,45), t=3
...
ARCHITECTURE eringa OF ering IS
  ...
  BEGIN
	...
	rin(16)<= rout(15) XOR rin0;
	rin(17)<= rout(16) XOR rin0;
...
BEGIN
	vdinR<= cout(0) AND NOT cout(1) AND cout(2) AND cout(3) AND NOT cout(4) AND cout(5); 
		-- reset vdin if cout==k-1
	vdinS<= ( cout(0) AND NOT cout(1) AND NOT cout(2) AND NOT cout(3) AND NOT cout(4) AND cout(5)) OR reset; 
		-- vdinS=1 if cout==n-1
